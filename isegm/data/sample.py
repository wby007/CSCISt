...
class DSample:
    ...
    def augment(self, augmentator):
        ...
        if self.points is not None:
            ...
            aug_output = augmentator(image=self.image, mask=self._encoded_masks, keypoints=points)
            self.points = self.postprocess_points(aug_output['keypoints'], pos_cnt, max_cnt)
        else:
