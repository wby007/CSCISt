...
def load_sample(root, id, annotation_dir='annotations', image_dir='train2014'):
...
class SA1BDataset(ISDataset):
    ...
    def __init__(self, dataset_dir, ids=None, annotation_dir='annotations', image_dir='train2014', min_object=1,
                 num_images=40670, **kwargs):
