    ...
    def get_sample(self, index) -> DSample:
        ...
        if self.select_proposal:
            ...
            if instances_mask is not None:
                ...
                return DSample(image, instances_mask, gra=gra, prompt=prompt, objects_ids=instances_ids, sample_id=index)
